...
public class ShinnUSTManager : MonoBehaviour
{
    ...
    public static Vector4 touchArea_value; //boundry left, right, top, bottom
    ...
    void OnGUI()
    {
        ...
        if (Enable)
        {
            ...
            if (showGui)
            {
                ...
                myButtonStyle.fontSize = _style.fontSize / 2;

                if (GUILayout.Button("Show URG Data", myButtonStyle, GUILayout.Width(700 * _style.fontSize / 30), GUILayout.Height(20 * _style.fontSize / 30)))
                    urg.DrawMesh = true;

                if (GUILayout.Button("Hide URG Data", myButtonStyle, GUILayout.Width(700 * _style.fontSize / 30), GUILayout.Height(20 * _style.fontSize / 30)))
                    urg.DrawMesh = false;
                ...
                if (GUILayout.Button("SAVE", myButtonStyle, GUILayout.Width(700 * _style.fontSize / 30), GUILayout.Height(20 * _style.fontSize / 30)))
                    SaveData();
                ...
                GUILayout.Space(40);
                if (GUILayout.Button("DEFAULT", myButtonStyle, GUILayout.Width(700 * _style.fontSize / 30), GUILayout.Height(20 * _style.fontSize / 30)))
                    Default();
    ...
    void SaveData()
    {
        ...
        if (MainUST)
        {
            ...
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch AreaPosX", TAoffPos.x);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch AreaPosY", TAoffPos.y);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch Width", scaleRate.x);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch Height", scaleRate.y);
    ...
    void Default()
    {
        ...
        if (MainUST)
        {
            ...
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch AreaPosX", data.TAoffPosx);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch AreaPosY", data.TAoffPosy);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch Width", data.scaleRatex);
            PlayerPrefs.SetFloat(USTObjs_Name + "Touch Height", data.scaleRatey);
        }
